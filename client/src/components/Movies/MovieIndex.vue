<template>
 ...
 <h4>จํานวนหนังทั้งหมด {{movies.length}} เรื่อง</h4><div><button @click="navigateTo('/movie/create')">เพื่มข้อมูล Movie</button>
 <button @click="navigateTo('/users')">กลับไป Users</button></div><hr>
